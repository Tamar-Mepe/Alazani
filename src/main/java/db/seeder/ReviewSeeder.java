        ...
        List<String> comments = new ArrayList<String>() {
            {
                ...
                add("Te has veritus sapientem, audire minimum scaevola vis ex, cum nonumy denique liberavisse ut. Elit augue definiebas ius ea, per omnium persequeris mediocritatem et. His ea posse impetus definitionem, cibo expetendis te vix. Zril deseruisse eam te. Eu eam soluta qualisque. Eos alii ferri splendide cu.");
            }
        };
